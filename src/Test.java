...
public class Test {
    public static void main(String[] args){
        ...
        System.out.println("=".repeat(100));
        System.out.println("sin: "+ComplexFunc.sin(num1));
        System.out.println("cos: "+ComplexFunc.cos(num1));
        System.out.println("tan: "+ComplexFunc.tan(num1));
        System.out.println("atan: "+ComplexFunc.atan(num1));
        System.out.println("sh: "+ComplexFunc.sh(num1));
        System.out.println("ch: "+ComplexFunc.ch(num1));
        System.out.println("th: "+ComplexFunc.th(num1));
        System.out.println("cth: "+ComplexFunc.cth(num1));
        System.out.println("=".repeat(100));
